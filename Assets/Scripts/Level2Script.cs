...
public class Level2Script : MonoBehaviour
{
    ...
    public Transform transportStart;
    public Transform transportEnd;
    public float transportSpeed = 3f;
    private bool isTransporting = false;
    private GameObject player;
    
    private Vector3 targetTransportPosition;
   ...
   // private bool level_complete = false;
    ...
    {
        SceneManager.LoadScene("Level3"); // Replace "NextScene" with the actual scene name or index
    }
    ...
    private void startTransport()
    {
        ...
        targetTransportPosition = transportEnd.position;
